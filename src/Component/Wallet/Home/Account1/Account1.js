    ...
    <>
        ...
        <div className="accountMenu">
            ...
            <div className="mt-4">
              <div className="list">
                  ...
                  <button className="links"><span className="listMenuIcon"><FontAwesomeIcon  icon={faShareSquare} /></span> Deposit Balance</button>
      ...
      <Overlay style={{border: 'none'}} className="overlay-container" configs={configs} isOpen={isOpen} closeOverlay={closeOverlay}>
            ...
            <div className="col-md-6">
                <div className="insideModal-content-container">
                  <div className="mt-3">
                    ...
                    <small>0xD58a109736D6b5436bc61321c93a43C0A21F9a6e</small>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="private-key-input-container">
                      ...
                      <div className="inside-modal-input3-container">
                        ...
                        <p>e40433629af19755bcdad9363c2b1821 <br/>f6b88ff91bf45eb527b75793453728e5</p>
                        </div>
                      </div>
                    </div>
        ...
        <div style={{ textAlign: "center" }}>
          <h5 className="head-title">Account <FontAwesomeIcon  icon={faPen} /></h5>
