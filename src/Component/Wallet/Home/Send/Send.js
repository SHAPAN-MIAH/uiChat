...
import { faArrowRight, faPaperPlane, faQrcode, faQuestionCircle, faSearch, faTimes, faChevronDown } from '@fortawesome/free-solid-svg-icons';
...
const Send = ({balance}) => {
  ...
  const handleChange = (e) => {
    const ethereumGasContainer = document.querySelector(".ethereum-gas-container");
    const sendModalContainer = document.querySelector(".send-modal-container");
    const ethAssetsSendSelectEthContainer = document.querySelector(".ethAssets-sendSelectEth-container");
  ...
  const SelectEthNumberHandler = (e)=>{
    const SelectEthNumber = document.querySelector("#AmountInput");
    ...
    const ethereumBalance = document.querySelector(".ethereumBalance").innerHTML;
   ...
   const lowHandler = () => {
    ...
    const mediumTransactionTime = document.querySelector(".medium-transaction-time");
    const highTransactionTime = document.querySelector(".high-transaction-time");
  ...
  const assetNameHandler = (e) => {
    ...
    const selectedAmountEthTitle = document.querySelector(".selected-amount-eth-title");
    const selectedAmountUsdTitle = document.querySelector(".selected-amount-usd-title");
  ...
  const advancedOptionsShowHandler = () =>{
    const GasLimitMpFeeContainer = document.querySelector(".Gas-limit-mp-fee-container");
    ...
    const warningCheckBoxHandler = () => {
      const warningConfirmBtnOverlay = document.querySelector(".warningConfirmBtn-overlay");
      warningConfirmBtnOverlay.style.display ="none"
    }
    ...
    const transactionHistorySave = (e) => {
      ...
      const transactionHistory = {
        ...
        senderId: "0xD58a109736D6b5436bc61321c93a43C0A21F9a6e",
      ...
      axios.post('https://thawing-falls-79270.herokuapp.com/addTransactionHistory', transactionHistory)
      .then(res => {
        console.log("done");
      })
    }
  ...
  return (
    <>
      <div className="buy-send-swap text-center">
        <div onClick={openModal} className="send"><FontAwesomeIcon className="icons" icon={faPaperPlane} /></div>
        <p>Send</p>
      </div>
      <Modal
        isOpen={modalIsOpen}
      ...
      >
            ...
            <div className="send-header-input">
              ...
              <div>
                ...
                <form>
                  ...
                  <input type="text" name="Search" id="Search" onChange={handleChange} placeholder="Search, public address " required/>
                  <FontAwesomeIcon className="qrcode-icon" icon={faQrcode} />
                </form>
              </div>
            </div>
            
            <span className="send-modal-close" onClick={closeModal}>cancel</span>
          </div>
          {/* <div className="f">
            <small>F</small>
          </div> */}
                ...
                searchUser.map((su, index) =>{
                  return (
                    ...
                    <div onClick={faucetHandler} className="faucet">
                      <div className="faucet-profile-img">
                      </div>
                      <div className="faucet-text">
                        <h6><span className="faucet-userName">{su.userName}</span> <br/> <span><small>0x81b7...7647</small></span></h6>
                      </div>
                      </div>
                    </li>
                  )
          ...
          <div className="faucet-footer">
            <div class="row">
              <div className="col-md-6">
                <a href=""> <h6>Public Address</h6></a>
                <small>A public address is just like a bank account number, the place you want to send/receive your crypto.</small>
              </div>
              <div className="col-md-6">
              <h6>Recipient</h6>
                <small>Anyone can receive cryptocurrency whether it's friends/relative, a business, or a person from across the globe that you have never met before.</small>
              </div>
        ...
        <div className="ethAssets-sendSelectEth-container">
          <div className='ethAssets-sendSelectEth-header'>
            <div className="faucet-id-container mb-3">
              <div className="faucet-id-header d-flex">
                <h6>Send</h6> 
                <p onClick={closeModal} className="faucet-ethAssets-sendSelectEth-container-close">close</p>
              </div>
              <div className="faucet-id-box">
                <div className="faucet-id-content d-flex">
                  <p className="f-name">Recipient Address <br/> <span className="f-id">{selectUsersName}</span></p>
                  <p onClick={closeModal} className="f-close-timesIcons"><FontAwesomeIcon icon={faTimes} /></p>
                </div>
              </div>
            </div>        
          </div>
                  ...
                  <div className='eth-balance-select-container d-flex align-items-center'>
                    ...
                    {/* <div className='balance-eth'>
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <p>ETH <br/> <span>Balance: <span className='ethereumBalance'>{ETHBalance}</span> ETH</span></p>
                        </div>
                      </div>
                    </div> */}
                    ...
                    <div className='balance-usd'>
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <p>USD <br/> <span>Balance: <span className='usdBalance'>{USDBalance}</span> USD</span></p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className='selectAsset-name'>
                      <select onClick={assetNameHandler} className='assetNameSelect' name='assetName'>
                  ...
                  <div className='eth-amount-max d-flex align-items-center'>
                    <div className='amount-eth'>
                      <div className='amount-eth d-flex align-items-center'>
                        <div>
                          {/* <img className='ethAmount-icon' width="20px" src={Eth} alt=""/> */}
                          <img className='usd-icon' width="22px" src={usd} alt=""/>
                        </div>

                        {/* Amount select input div */}
                        <div>
                          <p className='d-flex'>
                            <input type="text" name="Amount" id="AmountInput" onChange={SelectEthNumberHandler} placeholder="0.00" required/> 
                    ...
                    <button onClick={maxBtnHandler} id="maxBtn" type="">Max</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className='d-flex justify-content-center'>
            <button onClick={continueHandler} id='sendEthContinueBtn' type="">Continue</button>
          </div>
        </div>
        ...
        <div className="ethereum-gas-container">
          <div class="row">
            <div className="col-md-6">
              ...
              <video controls style={{ borderRadius: '5px', width: '350px', height: 'auto', boxShadow: 'rgba(0, 0, 0, 0.16) 0px 1px 4px'}}>
                <source
                  type="video/webm"
                  src={video7}
                />
              ...
              <div className="gas-text">
                <h6>Why do I need to specify a Transaction price and limit?</h6>
                <p>You can think of your Transaction limit like a budget you set for the miner processing your transactions. Transaction markets determine if and when transactions will get confirmed. 
                  <br/><br/> 
                  Set your Transaction price too low and your transaction may get stuck. Set your Transaction limit too low and your transaction cannot be executed because it runs out of Transaction.</p>
              </div>
            </div>
            ...
            <div className="col-md-6">
              <div className="d-flex mb-2">
                <div className="d-flex acc1">
                  ...
                  <small className="head-title d-flex justify-content-center">Account 1</small>
                </div>      
                <div className="d-flex acc2">
                  <FontAwesomeIcon className="acc2Icon" icon={faArrowRight} />
                  <img width="20px" src={userIcon2} alt=""/>
                  <small className="head-title d-flex justify-content-center">{selectUsersName.toString().substring(0, 5)}.....{selectUsersName.toString().substring(38)}</small>
                </div> 
              </div>   
              ...
              <div className="faucet-send-assets-amount-transaction">
                <div className="faucet-code-container mb-3"> 
                  <div className="select-amount-container">
                    ...
                    {/* <img className='selected-eth-icon' width="20px" src={Eth} alt=""/> */}
                    <img className='selected-usd-icon' width="22px" src={usd} alt=""/>

                      <div className="selected-eth">
                        <h5 className="selectedEthAmount d-flex">{selectedEthAmount} 
                          {/* <span className='selected-amount-eth-title'> ETH</span>  */}
                          <span className='selected-amount-usd-title'> USD</span>
                        </h5>
                      </div>
                    </div>
                  </div>
                ...
                <div className="estimated-fee d-flex">
                  <p>Estimated Transaction Fee <span><FontAwesomeIcon icon={faQuestionCircle} /></span></p>
                  
                    {/* <h6 className='gas-fee'>{gasFee}</h6> */}
                    <h6 className="low-gas-fee">0.00022</h6>
                    <h6 className="medium-gas-fee">0.00032</h6>
                    <h6 className="high-gas-fee">0.00042</h6>
                ...
                <div className="t-time-limit-container d-flex mb-3">
                  ...
                  <div className='advance-options-container'>
                    <div className='showAdvance'>
                      <span className='showAdvanceBtn' onClick={advancedOptionsShowHandler}>Advanced Options  <FontAwesomeIcon icon={faChevronDown} /></span>
                    </div>
                    <div className="Gas-limit-mp-fee-container">
                      <div className="d-flex m-1">
                        <small>Gas Limit <span className="question-icon"><FontAwesomeIcon icon={faQuestionCircle} /></span></small>
                        <div className="gwei">
                          <small>-37 GWEI</small>
                        </div>
                      </div>
                      <div className="d-flex m-1">
                        <small>Max Priority Fee <span className="question-icon"><FontAwesomeIcon icon={faQuestionCircle} /></span></small>
                        <div className="gwei">
                          <small>-37 GWEI</small>
                        </div>
                      </div>
                      <div className="d-flex m-1">
                        <small>Max Fee <span className="question-icon"><FontAwesomeIcon icon={faQuestionCircle} /></span></small>
                        <div className="gwei">
                          <small className="low-max-fee-gwei"><span>0.000045</span> GWEI</small>
                          <small className="medium-max-fee-gwei"><span>0.000056</span> GWEI</small>
                          <small className="high-max-fee-gwei"><span>0.000065</span> GWEI</small>
                ...
                <div className="slider-container text-center">
                  <div className="progressBar mb-2">
                    ...
                    <div className="stepper-wrapper">
                      <div onClick={lowHandler} className="stepper-item stepper-item1 completed">
                        <div className="step-counter low"></div>
                        <div className="step-name lowName"></div>
                      </div>

                      <div onClick={mediumHandler} className="stepper-item stepper-item2">
                        <div className="step-counter medium"></div>
                        <div className="step-name mediumName"></div>
                      </div>

                      <div onClick={highHandler} className="stepper-item stepper-item3">
                ...
                <div className="total-amount-container">
                  <div className="total-container d-flex">
                    <h6>Amount</h6>
                    <span className="lowTotalEth">{selectedEthAmount}  <span className='lowTotalTitle'>USD</span></span>
                    <span className="AllTotalEth">{selectedEthAmount} <span className='allTotalTitle'>USD</span></span>
                  </div>

                  <div className="amount-container d-flex">
                    <h6>TOTAL</h6>
                    {/* <span>{maxTotal} ETH</span> */}
                    <span className="lowMaxTotalEth">{lowTotal} <span className='lowMaxTotalTitle'>USD</span></span>
                    <span className="AllMaxTotalEth">{total} <span className='allMaxTotalTitle'>USD</span></span>
                ...
                <button onClick={backHandler} className="trans-fee-btn-cancel" type="">Reject</button>
                <button onClick={nextHandler} className="trans-fee-btn-next" type="">Confirm</button>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="warning-container text-center">
         ...
         <h5>Before you confirm, verify that the address you <br/> are sending to is correct.</h5>
         <br/>
         <div className="recipient-address-container text-center">
           <small>Recipient Address:</small>
            <h6>{selectUsersName}</h6>

            <small>Or, re-scan recipients QR code <FontAwesomeIcon className="re-scan-qrcode-icon" icon={faQrcode} /></small>
         </div>

         <div className="warning-text-div mt-3 mb-3">
           <small>If you input the wrong public address, you will <span style={{borderBottom: "1px solid red"}}>NOT</span> be able to recover the <br/> assets you send as they are irreversable always double check <br/> your recipient address.</small>
         </div>

          <div className="warningCheckbox">
          <input onClick={warningCheckBoxHandler} id="warningCheckbox" type="checkbox" name="" value=""/>
          <span>The address is above correct.</span>
          </div>

          <div className="warning-btn-div mt-3 mb-4">
            <button onClick={warningCancelBtnHandler} id="warningCancelBtn" type="">Reject</button>
            <button onClick={transactionHistorySave} id="warningConfirmBtn" type="">
              <span onClick={() => dispatch(showBalance(dispatchingData))}>
                <span onClick={closeModal}>Confirm</span>
              </span>
            </button>
